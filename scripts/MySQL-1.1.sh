...
force_pass() {
        ...
        echo 'echo -n "SCHEMA_NAME mydb"'> "/data/workspace/myshixun/src/step1/TestDb.sh"

}

normal_pass() {

    source /tmp/download.sh resource/MySQL-1.1/1-1.sql MySQL1-1.sql ${DownloadSite} ${Branch}

    mysql --force -uroot -p123123 -h127.0.0.1 < /tmp/MySQL1-1.sql
