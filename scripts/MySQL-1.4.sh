...
'echo " ::::::::::::::"
 ...
 echo "Field   Type    Null    Key     Default Extra"
 echo "id      int(11) NO      PRI     NULL"
 echo -n "name    varchar(22)     YES             NULL" ' > "/data/workspace/myshixun/src/step/TestDb.sh"

}

normal_pass() {

    source /tmp/download.sh resource/MySQL-1.4/1-4.sql MySQL1-4.sql ${DownloadSite} ${Branch}

    mysql --force -uroot -p123123 -h127.0.0.1 < /tmp/MySQL1-4.sql
