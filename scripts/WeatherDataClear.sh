...
force_pass() {
    ...
    source /tmp/download.sh resource/WeatherDataClear/output.txt WeatherDataClear ${DownloadSite} ${Branch}

    echo 'cat "/tmp/WeatherDataClear"' > "/data/workspace/myshixun/step1/1.sh"
