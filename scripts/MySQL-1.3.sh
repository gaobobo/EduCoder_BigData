...
'echo " ::::::::::::::"
 ...
 echo "userId  int(11) NO      PRI     NULL"
 echo "name    varchar(32)     YES             NULL"
 echo "password        varchar(11)     YES             NULL"
 echo "phone   varchar(11)     YES             NULL"
 echo "email   varchar(32)     YES             NULL"
 echo "Field   Type    Null    Key     Default Extra"
 echo "name    varchar(32)     NO      PRI"
 echo "phone   varchar(11)     NO      PRI"
 echo -n "email   varchar(32)     YES             NULL" ' > "/data/workspace/myshixun/src/step3/TestDb.sh"

}

normal_pass() {

    source /tmp/download.sh resource/MySQL-1.3/1-3.sql MySQL1-3.sql ${DownloadSite} ${Branch}

    mysql --force -uroot -p123123 -h127.0.0.1 < /tmp/MySQL1-3.sql
