...
force_pass() {
    ...
    source /tmp/download.sh resource/TelecomDataClear/output.txt TelecomDataClear ${DownloadSite} ${Branch}

    echo 'cat "/tmp/TelecomDataClear"' > "/data/workspace/myshixun/step1/1.sh"
