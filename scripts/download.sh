...
case $DownloadSite in
    Gitee)
        wget -O ${FilePath} https://gitee.com/coconut_floss/EduCoder_BigData/raw/${Branch}/${FileURL}
        ;;
    Github)
        wget -O ${FilePath} https://raw.githubusercontent.com/gaobobo/EduCoder_BigData/${Branch}/${FileURL}
        ;;
esac
